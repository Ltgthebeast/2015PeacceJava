...
import org.usfirst.frc.team3461.robot.commands.ExtendShooterCommand;
import org.usfirst.frc.team3461.robot.commands.RetractShooterCommand;
...
import org.usfirst.frc.team3461.robot.subsystems.VisionProcessing;
...
//        chooser.addObject("My Auto", new MyAutoCommand());
		...
		//CameraServer.getInstance().startAutomaticCapture("cam0");//if there is no physical camera the code will not upload
		
		SmartDashboard.putData("Extend Shooter", new ExtendShooterCommand());
		SmartDashboard.putData("Retract Shooter", new RetractShooterCommand());
    }
    ...
    public void updateVariables(){
    	SmartDashboard.putNumber("Pot Angle", Robot.shooterangle.getPosition());
		SmartDashboard.putNumber("Set Point", Robot.shooterangle.getSetpoint());
    }
    ...
    public void teleopPeriodic() {
        ...
        Robot.visionprocessing.updateVariable();
    	Robot.shooterangle.updateVariables();
    	Robot.visionprocessing.fixLeftRight();
