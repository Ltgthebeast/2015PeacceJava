...
public class BunnyEars extends Subsystem {
    ...
    {
    	if(LS3.get() != true) RightArmTalon.set(.25);
    	if(LS4.get() != true) RightArmTalon.set(-.25);
    	if(LS5.get() != true) LeftArmTalon.set(.25);
    	if(LS6.get() != true) LeftArmTalon.set(-.25);
    	else{
    		RightArmTalon.set(-speed*.25);
    		LeftArmTalon.set(-speed*.25);
    	}
    }
}
